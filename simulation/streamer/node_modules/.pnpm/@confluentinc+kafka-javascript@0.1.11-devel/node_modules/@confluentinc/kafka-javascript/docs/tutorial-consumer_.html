...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Tutorial: consumer</title>
...
<div id="main">
    ...
    <h1 class="page-title">Tutorial: consumer</h1>
...
<article>
    <p>Connecting to a Kafka Consumer is easy. Let's try to connect to one using
the Stream implementation</p>
