...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Tutorial: high-level-producer</title>
...
<div id="main">
    ...
    <h1 class="page-title">Tutorial: high-level-producer</h1>
...
<header>
    ...
    <h2>high-level-producer</h2>
</header>

<article>
    <pre class="prettyprint source lang-js"><code>var Kafka = require('../');
