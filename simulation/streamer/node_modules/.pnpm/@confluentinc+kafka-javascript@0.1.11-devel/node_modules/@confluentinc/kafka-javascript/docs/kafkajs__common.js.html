...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: kafkajs/_common.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: kafkajs/_common.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const error = require("./_error");
...
const CompatibilityErrorMessages = Object.freeze({
  ...
  /* Consumer */
  partitionAssignors: () =>
    'partitionAssignors must be a list of strings from within `PartitionAssignors`, and the cooperativeSticky assignor is not yet supported.\n',
  ...
  runOptionsEachBatch: () =>
    "The property 'eachBatch' is not currently supported by run\n",
});
